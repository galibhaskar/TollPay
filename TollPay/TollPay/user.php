            ...
            <div class="container register">
                <div class="row">
                    ...
                    <div class="tab-content" id="myTabContent">
                        <div class="tab-pane show active" id="profile" role="tabpanel" aria-labelledby="profile-tab">
                            ...
                            <div class="row register-form">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <input type="password" class="form-control" name="psd" placeholder="Password *" value="" />
                                    </div>
                                    <input type="submit" class="btnRegister" onclick="fun()" value="login"/>
                                </div>
                            </div>
                        </div>
                    </div>
                    <ul class="nav nav-tabs nav-justified" id="myTab" role="tablist">
                            <li class="nav-item">
                                <a class="nav-link active" id="home-tab" role="tab" aria-controls="home" aria-selected="true">user</a>
                            </li>
                        </ul>
                </div>
